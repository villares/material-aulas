...
[**instrução `global`**](https://penseallen.github.io/PpensePython2e/11-dicionarios.html#termo:instrução%20global) Instrução que declara um nome de variável global.
