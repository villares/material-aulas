...
* [background()](http://py5coding.org/reference/sketch_background.html) - O plano de fundo() A função define a cor usada para o fundo da janela py5.
...
* [key](http://py5coding.org/reference/sketch_key.html) - A variável do sistema key sempre contém o valor da tecla mais recente no teclado que foi usada (pressionada ou liberada).
* [key_code](http://py5coding.org/reference/sketch_key_code.html) - A variável key_code é usada para detectar teclas especiais, como as teclas de seta (UP, DOWN, LEFT e RIGHT), bem como ALT, CONTROL, e MUDANÇA.
...
* [mouse_button](http://py5coding.org/reference/sketch_mouse_button.html) - Quando um botão do mouse é pressionado, o valor da variável do sistema mouse_button é definido como LEFT, RIGHT ou CENTER, dependendo de qual botão é pressionado .
...
* [print_line_profiler_stats()](http://py5coding.org/reference/sketch_print_line_profiler_stats.html) - Imprima as estatísticas do criador de perfil de linha iniciadas com profile_draw() ou profile_functions().
* [profile_draw()](http://py5coding.org/reference/sketch_profile_draw.html) - Crie o perfil dos tempos de execução da função de desenho com um criador de perfil de linha.
* [profile_functions()](http://py5coding.org/reference/sketch_profile_functions.html) - Faça o perfil dos tempos de execução das funções do Sketch com um criador de perfil de linha.

#### Linhas de execução (*Threading*)

* [has_thread()](http://py5coding.org/reference/sketch_has_thread.html) - Determina se um thread de um determinado nome existe e está em execução no momento.
* [join_thread()](http://py5coding.org/reference/sketch_join_thread.html) - Junte-se ao thread Python associado ao nome do thread fornecido.
...
* [Py5 Functions](http://py5coding.org/reference/py5functions.html) - As funções py5 são funções utilitárias extras que tornam o py5 mais fácil de usar. Por exemplo, você pode usá-los para os arquivos de fonte vlw do Processing sem precisar usar o IDE do Processing.
