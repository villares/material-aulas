...
summary = Path("/home/villares/GitHub/material-aulas/Processing-Python-py5/sumario-referencia-py5.md")
template = Path('summary_template.html').read_text()
...
output_path = Path.cwd().parent / 'summary.html'
