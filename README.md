...
> - Biblioteca [py5](https://py5coding.org) - ([**instruções de instalação** usando Thonny IDE + plugin](https://github.com/villares/thonny-py5mode/tree/pt-br), recomendada para a versão mais recente deste material)
